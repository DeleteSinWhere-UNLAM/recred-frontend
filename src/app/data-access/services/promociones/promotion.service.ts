...
export class PromotionService {
  ...
  getPromotions(buffetId?: string): Observable<Promotion[]> {
    const id = buffetId ?? this.perfilService.obtenerBuffetId();
    return this.http.get<Promotion[]>(`${this.apiUrl}/buffet/${id}`);
  }
