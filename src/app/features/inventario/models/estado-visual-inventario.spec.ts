...
import { ItemInventario, EstadoInventario, TipoManejoInventario } from './inventario.model';

describe('EstadoVisualInventario', () => {
  const createMockProduct = (overrides: Partial<ItemInventario> = {}): ItemInventario => ({
    productId: '1',
    nombre: 'Test Product',
    stockDisponible: 10,
    stockReservado: 0,
