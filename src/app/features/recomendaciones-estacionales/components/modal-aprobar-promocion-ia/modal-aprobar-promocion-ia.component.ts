...
@Component({
  ...
  templateUrl: './modal-aprobar-promocion-ia.component.html',
  styleUrls: ['./modal-aprobar-promocion-ia.component.css']
})
export class ModalAprobarPromocionIaComponent implements OnInit {
