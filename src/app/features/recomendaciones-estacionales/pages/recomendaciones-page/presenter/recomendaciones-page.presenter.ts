...
export class RecomendacionesPagePresenter {
  ...
  private readonly seasonInfoState = signal<InfoEstacion | null>(null);
  private readonly weatherInfoState = signal<InfoClima | null>(null);
  ...
  readonly seasonInfo: Signal<InfoEstacion | null> = this.seasonInfoState.asReadonly();
  readonly weatherInfo: Signal<InfoClima | null> = this.weatherInfoState.asReadonly();
