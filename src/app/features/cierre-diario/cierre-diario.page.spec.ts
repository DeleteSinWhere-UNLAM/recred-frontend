...
describe('CierreDiarioPage', () => {
  ...
  let dailyCloseService: jasmine.SpyObj<CierreDiarioService>;
  ...
  beforeEach(async () => {
    dailyCloseService = jasmine.createSpyObj<CierreDiarioService>(
      'CierreDiarioService',
      [
        'getReporteDiario',
    ...
    dailyCloseService.getReporteDiario.and.returnValue(of(report));
    inventoryRealtimeService.connect.and.returnValue(new AbortController());
    dailyCloseService.getEstadoCierreDiario.and.returnValue(
      of({
        buffetId,
        date: report.date,
        closed: false,
    ...
    dailyCloseService.getReporteDiarioCsvUrl.and.returnValue('/daily.csv');
    dailyCloseService.downloadReporteDiarioCsv.and.returnValue(
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: CierreDiarioService, useValue: dailyCloseService },
  ...
  it('deberia cargar el reporte diario al iniciar', () => {
    ...
    expect(dailyCloseService.getReporteDiario).toHaveBeenCalledWith(
      buffetId,
      jasmine.any(String),
    );
    expect(dailyCloseService.getEstadoCierreDiario).toHaveBeenCalledWith(
      buffetId,
      jasmine.any(String),
    );
  ...
  it('deberia ordenar el inventario dejando agotados y bajo stock primero', () => {
    dailyCloseService.getReporteDiario.and.returnValue(
      of({
        ...report,
        inventory: [
          {
  ...
  it('deberia descargar el CSV usando el servicio autenticado', () => {
    ...
    expect(dailyCloseService.downloadReporteDiarioCsv).toHaveBeenCalledWith(
      buffetId,
      jasmine.any(String),
    );
