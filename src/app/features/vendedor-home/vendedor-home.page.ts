...
import { EstadisticaCardComponent } from './components/estadistica-card/estadistica-card.component';

@Component({
  selector: 'app-vendedor-home-page',
  templateUrl: './vendedor-home.page.html',
  styleUrl: './vendedor-home.page.css',
  imports: [NavbarComponent, AccionCardComponent, EstadisticaCardComponent],
})
export class VendedorHomePage {
  private readonly usuarioService = inject(UsuarioService);

  private readonly vendedorHomeService = inject(VendedorHomeService);

  readonly nombreUsuario = this.usuarioService.getUsuarioActual().nombre;

  readonly resumen = this.vendedorHomeService.getResumen();
}
