...
describe('ResumenPrediccionComponent', () => {
  let componente: ResumenPrediccionComponent;
  ...
  describe('comportamiento del bloque limite', () => {
    it('dado que no hay montoLimite, debe mostrar el mensaje de vacío', () => {
      ...
      const msjVacio = fixture.debugElement.query(By.css('.resumen-prediccion__vacio'));
    ...
    it('dado que hay montoLimite, debe renderizar la barra y el limite', () => {
      ...
      componente.porcentajePresupuesto = 0.5;
      fixture.detectChanges();

      const limiteBlock = fixture.debugElement.query(By.css('.resumen-prediccion__limite'));
      expect(limiteBlock).not.toBeNull();

      const barraFill = fixture.debugElement.query(By.css('.resumen-prediccion__barra-fill')).nativeElement as HTMLElement;
    ...
    it('dado que el porcentaje sobrepasa 1, el limite maximo visual de la barra debe ser 100%', () => {
      componente.montoLimite = 10000;
      componente.porcentajePresupuesto = 1.2;
      fixture.detectChanges();
    ...
    it('dado que el porcentaje sobrepasa 0.8, debe aplicar la clase danger', () => {
      componente.montoLimite = 10000;
      componente.porcentajePresupuesto = 0.85;
      fixture.detectChanges();

      const limiteBlock = fixture.debugElement.query(By.css('.resumen-prediccion__limite')).nativeElement as HTMLElement;
      expect(limiteBlock.classList.contains('resumen-prediccion__limite--danger')).toBeTrue();
    });
  });
  ...
  describe('comportamiento del renderizado general y pipes', () => {
    it('dado que recibe datos validos, debe mostrarlos formateados', () => {
      ...
      componente.confianza = 0.89;
      componente.diasHistoricosUsados = 30;
      componente.diasRestantes = 5;
      fixture.detectChanges();

      const titulo = fixture.debugElement.query(By.css('.resumen-prediccion__titulo')).nativeElement;
      expect(titulo.textContent).toContain('Abril 2024');

      const gastos = fixture.debugElement.queryAll(By.css('.resumen-prediccion__card-valor'));
      expect(gastos[0].nativeElement.textContent).toContain('1,500.5');

      const stats = fixture.debugElement.queryAll(By.css('.resumen-prediccion__stat-valor'));
