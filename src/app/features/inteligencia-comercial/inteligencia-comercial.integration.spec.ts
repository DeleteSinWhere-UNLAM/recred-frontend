...
describe('InteligenciaComercial Integration', () => {
  ...
  it('dadas oportunidades y baja rotacion, deberia renderizar resumen y pestañas', () => {
    ...
    expect(texto).toContain('Inteligencia comercial');
    ...
    const tabs = fixture.debugElement.queryAll(By.css('.si__pestania'));
    tabs[1].nativeElement.click();
    fixture.detectChanges();

    expect(fixture.nativeElement.textContent).toContain('Productos con baja rotacion');
